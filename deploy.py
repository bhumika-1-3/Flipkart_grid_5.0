...
address = w3.to_checksum_address("0x4B14305715F7674a486C26Cfb8a28Be96049598b")
abi = json.loads('''[
	{
		"inputs": [],
...
loyaltyToken = w3.eth.contract(address=address, abi=abi)

print(loyaltyToken.functions.balanceOf(public_key).call())

amount = int(input("Enter amount: "))

tx = loyaltyToken.functions.mintForUser(public_key, amount).build_transaction({
    'chainId': 5,
    'from': public_key,
    'gas': 3000000,
