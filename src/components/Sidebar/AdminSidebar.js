...
import { MdProductionQuantityLimits, MdVideoCall } from "react-icons/md";
...
export default function Sidebar() {
  ...
  var { isAdmin } = useSelector((state) => state.auth);
      ...
      <nav
        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <Link
            ...
            className="inline-block text-left text-purple_1 dark:border-purple-700 dark:text-slate-200 mr-0 whitespace-nowrap text-xl font-semibold"
            to="/dashboard/">
            {/* JEET */}
            <img
